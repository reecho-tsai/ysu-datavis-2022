...
data_path = "..\\dataset\\cpu\\DESKTOP-5GTCQEM_20221009-000402\\DataCollector01.csv"  # 数据相对路径
...
for i in range(1, col_num):
    ...
    # 调用plt画图，数据为data中按列名索引的数据并强转为float类型
    plt.plot(data[colunm_name].astype(float))
